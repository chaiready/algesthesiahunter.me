  ...
  <div class="about-page">
    <div class="block">
      <div class="its">
        <div class="content">
          <div class="it">
            <svg-icon icon-class="about" class="icon about"></svg-icon>
            <div>爱我的人和我爱的人对美好生活的向往，就是我的奋斗目标</div>
          </div>
          <div class="it">
          ...
          <div class="it">
            ...
            <div>
              指弹爱好者、骑行爱好者、技术爱好者、灵韵爱好者、二次元爱好者
            </div>
          </div>
          <div class="it">
            <svg-icon icon-class="address" class="icon address"></svg-icon>
            <div>中国·深圳·南山区·西丽</div>
          </div>
          <div class="it">
      ...
      <div class="its">
        <div class="me">
          <img
            :src="
              getImgUrl('me.png' + '?x-oss-process=image/resize,m_lfit,w_100')
            "
            class="avatar"
            alt
          />
          ...
          <img
            :src="
              getImgUrl(
                'weixin.png' + '?x-oss-process=image/resize,m_lfit,w_240'
              )
            "
            class="wx"
            alt
