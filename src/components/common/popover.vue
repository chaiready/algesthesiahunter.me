<!--
 * @Description:popconfirm组件的自定义内容
    ...
    <div class="popover-main">
      ...
      <div class="popover-inner">
        <div class="inner-main">
          ...
          <div class="btns">
            <span class="btn cancel" @click="delPop">取消</span>
            <ElButton
              class="btn sub-btn"
...
<script>
import { delPop } from 'utils/PopConfirm'
export default {
  name: 'popover',
  props: {
    x: {},
...
.popover {
  ...
  .popover-main {
    .popover-arrow {
      ...
      border-right-color: $module-bg;
      border-bottom-color: $module-bg;
